...
namespace RageRunGames.EasyFlyingSystem
{
    ...
    {
        public event Action<bool> ThrottleIsZero;
        ...
        [SerializeField] private bool _throttle = false;
        ...
        public virtual void OnPointerUp(PointerEventData eventData) {
            if (_throttle && knob.anchoredPosition.y <= -150f) {
                ThrottleIsZero?.Invoke(true);
                return;
            }
